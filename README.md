...
<p align="center">
  ...
  <h1 align="center">rusty-iot</h1>
</p>

The rusty-iot project is firmware for the [`rp2040`][1] based on the [`embassy`][2] asynchronous embedded development framework for [Rust][3].
